Attribute VB_Name = "Cancellation_Rules"
Sub Cancellation_Rules()
...
'FORM SEQUENCE (AGENT 5)
    ...
    'CENTER ALIGN
    Range("B:D,E:H,P:X,AA:AD,AH:AJ,AM:AP,AS:AS,BR:BS"). _
        Select
    Selection.HorizontalAlignment = xlCenter

'DATES - SET SHORT DATE FORMAT
    Range("P:Q,S:U,BR:BS").Select
    With Selection
...
'$$ - RIGHT ALIGN AND ADD DECIMAL PLACES
    Range("O:O,Y:Z,AE:AF,AK:AL,AQ:AR"). _
        Select
    With Selection
